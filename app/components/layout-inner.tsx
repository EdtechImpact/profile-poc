...
export default function LayoutInner({ children }: { children: ReactNode }) {
  ...
  return (
    <>
      ...
      <button
        onClick={() => setShowSettings(true)}
        className="fixed bottom-5 right-5 z-40 w-10 h-10 rounded-full bg-white shadow-lg border border-slate-200 flex items-center justify-center hover:shadow-xl hover:scale-105 transition-all group"
        title="AWS Settings"
      >
